...
class DownloadsPage(Page):
    ...
    def __init__(self, *args):
        ...
        self.view_image = PhotoImage(file='images/view_lbl.png')
        self.player = Label(self, image=self.view_image)
        ...
        self.player.pack(side="left", padx=300)
    ...
    def play_video(self, path):
        player = tkvideo(path, self.player, loop=0, size=(1280, 720))
        player.play()
